...
NOTION_PROVISIONEN_DB_ID = os.getenv("NOTION_PROVISIONEN_DB_ID", "")
...
DAILY_COLUMNS = [
    ...
    "notion_provision_eur",
    "manual_license_revenue",
    "zoho_deals_total",
    "zoho_deals_new",
    "zoho_deals_active",
    "zoho_deals_won",
...
KPI_DISPLAY = {
    ...
    "notion_provision_eur": {"label": "Provision Energie", "icon": "💰", "format": "{:,.0f} €", "category": "Revenue"},
    "manual_license_revenue": {"label": "Lizenzumsatz", "icon": "📄", "format": "{:,.0f} €", "category": "Revenue"},
